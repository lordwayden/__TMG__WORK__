#! /bin/bash
# MAINTAINER i.hordiichuk hordijchuk@me.com
...
# Enter Domain
apt-get install realmd adcli sssd krb5-workstation oddjob-mkhomedir samba-common-tools policycoreutils-python
